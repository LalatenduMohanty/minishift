...
gen_adoc_tar: synopsis_docs build_docs_container
	cd docs && docker run -e OPENSHIFT_VERSION=$(OPENSHIFT_VERSION) -e MINISHIFT_VERSION=$(MINISHIFT_VERSION) -e CENTOS_ISO_VERSION=$(CENTOS_ISO_VERSION) -tiv $(shell pwd)/docs:/home/docs:Z minishift/docs clean adoc_tar

.PHONY: gen_docs
gen_docs: synopsis_docs build_docs_container
	cd docs && docker run -e OPENSHIFT_VERSION=$(OPENSHIFT_VERSION) -e MINISHIFT_VERSION=$(MINISHIFT_VERSION) -e CENTOS_ISO_VERSION=$(CENTOS_ISO_VERSION) -tiv $(shell pwd)/docs:/home/docs:Z minishift/docs gen

.PHONY: clean_docs
clean_docs: build_docs_container
	cd docs && docker run -e OPENSHIFT_VERSION=$(OPENSHIFT_VERSION) -e MINISHIFT_VERSION=$(MINISHIFT_VERSION) -e CENTOS_ISO_VERSION=$(CENTOS_ISO_VERSION) -tiv $(shell pwd)/docs:/home/docs:Z minishift/docs clean

.PHONY: serve_docs
serve_docs: synopsis_docs build_docs_container
	cd docs && docker run -e OPENSHIFT_VERSION=$(OPENSHIFT_VERSION) -e MINISHIFT_VERSION=$(MINISHIFT_VERSION) -e CENTOS_ISO_VERSION=$(CENTOS_ISO_VERSION) -p 35729:35729 -p 4567:4567 -tiv $(shell pwd)/docs:/home/docs:Z minishift/docs serve[--watcher-force-polling]
