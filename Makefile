...
# Setup for the documentation tasks
DOC_VARIABLES = '-e OPENSHIFT_VERSION=$(OPENSHIFT_VERSION) -e MINISHIFT_VERSION=$(MINISHIFT_VERSION) \
			-e CENTOS_ISO_VERSION=$(CENTOS_ISO_VERSION)'
